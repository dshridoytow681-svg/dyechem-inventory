...
class GeminiVoiceService {
    ...
    suspend fun getSmartAIResponse(userVoiceInput: String, inventoryContext: String): String {
        ...
        val isBengali = userVoiceInput.any { it.code in 0x0980..0x09FF }
        val languageInstruction = if (isBengali)
            "The user has written in Bengali. You MUST respond entirely in Bengali (বাংলায় উত্তর দিন). Do not use English in your response."
        else
        ...
        val promptText = """
            ...
            Keep your response short, highly informative, concise, professional and objective.
            $languageInstruction
        ...
        val systemInstruction = if (isBengali)
            "তুমি একজন রাসায়নিক ও রঞ্জক গুদামঘরের বিশেষজ্ঞ ম্যানেজার। সর্বদা বাংলায় উত্তর দাও। সংক্ষিপ্ত (সর্বোচ্চ ২-৩ বাক্য), তথ্যপূর্ণ এবং বিনম্র থাকো।"
        else
